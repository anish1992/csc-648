...
/**
 * RestaurantContactDB provides functions to either insert or retrieve
 * restaurant information related to its location and other contact
 * information.
 *
 * @author Gary Ng
 */
class RestaurantContactDB extends DatabaseHelper {
    ...
    /**
     * Retrieves a list of cities using a name. Existing cities only include
     * the ones attached to existing restaurants.
     */
    ...
    /**
     * Retrieve restaurant location information using a restaurant ID with
     * values stored as a location instance.
     */

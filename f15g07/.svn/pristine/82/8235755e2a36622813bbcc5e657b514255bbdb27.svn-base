...
if (isset($_SESSION['user'])) {
    ...
    $error = "Please log in as administrator";
}

if ($error != null) {
?>
    <h2 id="admin-error"><?php echo $error; ?></h2>
<?php
    exit;
}
?>
...
<div id="admin-div">
    <a href="http://www.sfsuswe.com/phpmyadmin" id="admin-form-edit" class="btn btn-default form-control">Go to MySQL Database</a>

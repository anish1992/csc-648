        ...
        <div class="collapse navbar-collapse navbar-menubuilder">
            <ul class="nav navbar-nav navbar-right" style="padding: 0; margin:0.5em 0 0 0;">
                <?php if (!isset($_SESSION['user'])) { ?>                                                                              <!-- href="signup.php"-->
                    <li><h4 style="padding-right: 0.75em; "><a href="#" data-toggle="modal" data-target="#myModal_signup">Sign Up</a></h4>
                    </li>
                <?php } else { ?>
                    <li><h4 style="padding-right: 0.75em; "><a href="action.php?action=logout">Log Out</a></h4>
                    </li>
                <?php } ?>
                <?php if (!isset($_SESSION['user'])) { ?>
                    <li><h4><a  data-toggle="modal" data-target="#myModal_signin">Sign In</a></h4></li>
                <?php } else { ?>
                    <li><h4><a data-toggle="modal" data-target="#myModal_user"><?php echo $_SESSION['user']->username ?></a></h4></li>
                <?php } ?>
            </ul>
        </div>
    </div>
